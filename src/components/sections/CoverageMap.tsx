    ...
    <section id="about-us" className="section-padding overflow-x-clip bg-brand-sand">
      <div className="container">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-10 xl:gap-12">
          ...
          >
            <div className="rounded-2xl bg-white p-4 shadow-soft sm:p-5 lg:p-6">
              <FloridaMap className="w-full" />
              <p className="mt-3 hidden text-center text-xs text-brand-muted lg:block">
                Hover pins for coverage areas across the state
              </p>
            </div>
          </motion.div>
        </div>
